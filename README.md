...
- Thousands of packages installed globally, including (selection):  
  - **AI / LLM & tooling**  
...
`pipx` is used to isolate complex tools into separate venvs. Examples:  
...
The Mac hosts a **large Ollama model zoo** optimised for different tasks:
